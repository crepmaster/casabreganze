...
export const ui = {
  fr: {
    ...
    'calendar.title': 'Disponibilités',
    'calendar.subtitle': 'Calendrier indicatif — l’agence confirme sous 15 min.',
    'calendar.available': 'Libre',
    'calendar.booked': 'Réservé',
    'calendar.wa_message': 'Bonjour, l’appartement EasyRest est-il libre à partir du {date} ?',
  ...
  en: {
    ...
    'calendar.subtitle': 'Indicative calendar — our team confirms within 15 min.',
    'calendar.available': 'Available',
    'calendar.booked': 'Booked',
    'calendar.wa_message': 'Hello, is the EasyRest apartment available from {date}?',
  ...
  it: {
    ...
    'calendar.subtitle': 'Calendario indicativo — il team conferma entro 15 min.',
    'calendar.available': 'Libero',
    'calendar.booked': 'Occupato',
    'calendar.wa_message': 'Buongiorno, l’appartamento EasyRest è libero dal {date}?',
  ...
  es: {
    ...
    'calendar.title': 'Disponibilidad',
    'calendar.subtitle': 'Calendario indicativo — el equipo confirma en 15 min.',
    'calendar.available': 'Libre',
    'calendar.booked': 'Ocupado',
    'calendar.wa_message': 'Hola, ¿está libre el apartamento EasyRest a partir del {date}?',
